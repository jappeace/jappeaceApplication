    ...
    H.section ! A.class_ "audit" $ do
      ...
      H.div ! A.class_ "audit-grid" $ do
        H.div $ do
          ...
          H.p $ H.preEscapedToHtml ("Ik doe dit niet alleen. Leana kwam bij het bedrijf om een opdracht voor de Haskell Foundation uit te voeren en is een expert in build-systemen; het migratievak leert ze er in de praktijk bij." :: Text)
