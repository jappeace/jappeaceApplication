...
*** Patron
** Advertising
This is a special snow flake,
because in principal advertisement and open source can go hand in hand.
However do note that anyone can take your source code, 
remove the advertisements, and redistribute it.
Some [[https://en.wikipedia.org/wiki/Homo_economicus][economic models]] would predict that this would be the end of your project,
because advertisements give negative utility for the consumer,
although most people would probably just see it as a dick move.
So I think this would be viable (and have seen some android apps do this).
...
My blog seems to be really focussed on money,
